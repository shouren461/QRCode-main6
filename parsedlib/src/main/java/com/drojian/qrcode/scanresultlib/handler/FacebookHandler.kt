 ...
 */
class FacebookHandler(activity: Activity, val parsedModel: ParseFacebookModel, resultHandlerConfig: ResultHandlerConfig) : BaseResultHandler(activity, parsedModel, resultHandlerConfig) {
