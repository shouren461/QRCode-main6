 ...
 */
class PaypalHandler(activity: Activity, val parsedModel: ParsePaypalModel, resultHandlerConfig: ResultHandlerConfig) : BaseResultHandler(activity, parsedModel, resultHandlerConfig) {
