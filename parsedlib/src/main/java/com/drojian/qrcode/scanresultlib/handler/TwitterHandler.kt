 ...
 */
class TwitterHandler(activity: Activity, val parsedModel: ParseTwitterModel,resultHandlerConfig: ResultHandlerConfig) : BaseResultHandler(activity, parsedModel,resultHandlerConfig) {
