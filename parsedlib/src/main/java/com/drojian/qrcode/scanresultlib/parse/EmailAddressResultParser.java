...
public final class EmailAddressResultParser extends ResultParser {
    ...
    @Override
    public ParseEmailModel parse(ScanResultModel result) {
        ...
        if (rawText.startsWith("mailto:") || rawText.startsWith("MAILTO:")) {
            ...
            return new ParseEmailModel(tos, ccs, bccs, subject, body);
        } else {
            if (!EmailDoCoMoResultParser.isBasicallyValidEmailAddress(rawText)) {
                return null;
            }
            return new ParseEmailModel(new String[]{rawText}, null, null, null, null);
        }
    }
