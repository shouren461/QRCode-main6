...
final class ProductResultInfoRetriever extends SupplementalInfoRetriever {
    ...
    ProductResultInfoRetriever(String productID) {
        super();
    ...
    void retrieveSupplementalInfo() throws IOException {
        ...
        String uri = "https://www.google." + LocaleManager.getProductSearchCountryTLD()
                + "/m/products?ie=utf8&oe=utf8&scoring=p&q=" + encodedProductID;//&source=zxing
