 ...
 */
class WhatsAppHandler(activity: Activity, val parsedModel: ParseWhatsAppModel,resultHandlerConfig: ResultHandlerConfig) : BaseResultHandler(activity, parsedModel,resultHandlerConfig) {
