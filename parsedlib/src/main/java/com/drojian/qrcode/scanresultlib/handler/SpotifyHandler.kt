 ...
 */
class SpotifyHandler(activity: Activity, val parsedModel: ParseSpotifyModel, resultHandlerConfig: ResultHandlerConfig) : BaseResultHandler(activity, parsedModel, resultHandlerConfig) {
